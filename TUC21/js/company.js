...
btn.forEach((element, index) => {
    element.addEventListener("click", () => {
        ...
        switch (index) {
            case 0:
                url = "components/homeCompany.php"; //home
                break;
            case 1:
                url = "components/internsCompany.php?"; //estagiários
                break;
            case 2:
                url = "components/employeesCompany.php?"; //funcionários
                break;
            case 3:
                url = "components/profileCompany.php"; //perfil
                break;
        }
...
function getEmployeeContent() {
    ...
    let request = new XMLHttpRequest();
    request.open("POST", "content/employeeContent.php");
    request.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
