...
btn.forEach((element, index) => {
    element.addEventListener("click", () => {
        ...
        switch (index) {
            case 0:
                url = "components/homeProfessor.php"; //home
                break;
            case 1:
                url = "components/usersProfessor.php?"; //funcionários
                break;
            case 2:
                url = "components/studentsProfessor.php"; //alunos
                break;
            case 3:
                url = "components/internProfessor.php"; //estagiários
                break;
            case 4:
                url = "components/reportsProfessor.php"; //relatórios
                break;
            case 5:
                url = "components/internshipPlanProfessor.php"; //plano de estgágio
                break;
            case 6:
                url = "components/universityProfessor.php"; //instituição de ensino
                break;
            case 7:
                url = "components/profileProfessor.php"; //perfil
                break;
        }
...
function exclude(type, id) {
    ...
    switch (type) {
        case 10:
            typeString = "person";
            textModal = "desta pessoa";
            break;
        case 15:
            typeString = "student";
            textModal = "deste estudante";
            break;
    }
    ...
    myModalMessage.innerHTML = "Confirmar exclusão " + textModal;
...
function recycle(type, id) {
    ...
    myModalTitle.innerHTML = "Reativar";
