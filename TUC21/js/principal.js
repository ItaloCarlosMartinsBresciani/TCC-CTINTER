...
btn.forEach((element, index) => {
    element.addEventListener("click", () => {
        ...
        switch (index) {
            case 0:
                url = "components/homePrincipal.php"; //home
                break;
            case 1:
                url = "components/usersPrincipal.php?"; //funcionários
                break;
            case 2:
                url = "components/studentsPrincipal.php?"; //alunos
                break;
            case 3:
                url = "components/universityPrincipal.php"; //universidade
                break;
            case 4:
                url = "components/companyPrincipal.php"; //companhia
                break;
            case 5:
                url = "components/profilePrincipal.php"; //perfil
                break;
        }
...
function exclude(type, id) {
    ...
    myModalMessage.innerHTML = "Confirmar exclusão deste(a) " + textModal;
...
function recycle(type, id) {
    ...
    myModalTitle.innerHTML = "Recuperação";
    myModalMessage.innerHTML = "Recuperar este(a) " + textModal;
