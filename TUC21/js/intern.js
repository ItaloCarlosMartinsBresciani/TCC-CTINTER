...
btn.forEach((element, index) => {
    element.addEventListener("click", () => {
        ...
        switch (index) {
            case 0:
                url = "components/homeIntern.php"; //home
                break;
            case 1:
                url = "components/advisorIntern.php";  //orientador
                break;
            case 2:
                url = "components/supervisorIntern.php"; //supervisor
                break;
            case 3:
                url = "components/coordinatorIntern.php"; //supervisor
                break;
            case 4:
                url = "components/companyIntern.php"; //empresa
                break;
            case 5:
                url = "components/documentsIntern.php"; //documentos
                break;                
            case 6:
                url = "components/reportsIntern.php"; //relatórios
                break;
            case 7: 
                url = "components/profileIntern.php"; //perfil
                break;   
            case 8: 
                url = "components/internshipIntern.php"; //perfil
                break;        
        }
