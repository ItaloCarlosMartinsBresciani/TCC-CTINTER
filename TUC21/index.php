    ...
    <div class="container min-vh-100">
        ...
        <div class="w-100 rounded bg-primary" style="padding: 8em 1em;">
            <div class="text-center">
                ...
                <div class="google-login d-flex justify-content-center">
                    <div id="g_id_onload"
                        ...
                        data-context="signin"
                        data-ux_mode="popup"
                        data-login_uri="http://localhost/UNESP-Internship/TUC21/app/php/google/verifyIntegrity.php"
         ...
         <footer class="text-center pt-5 pb-3">
             &copy; 2022 CTI - Colégio Técnico Industrial "Prof. Isaac Portal Roldán" <div style ="text-align: right;" ><a href="whoarewe.php"><button type="button" class="btn btn-primary">Quem somos?</button></a>     
        </div>
