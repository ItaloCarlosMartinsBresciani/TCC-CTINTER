<?php
  ...
  do {
    ...
    if ($payload) {
      ...
      $_SESSION['name-student'] = $data->name;
      $_SESSION['email-student'] = $data->email;
      $_SESSION['done'] = 1;
      header('Location: ../../../views/putStudentInformation.php?key='.$_GET["key"].'&id_coordinator='.$_GET["id_coordinator"]);
