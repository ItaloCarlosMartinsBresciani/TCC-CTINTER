<?php
  ...
  do {
    ...
    if ($payload) {
      ...
      $_SESSION['name-professor'] = $data->name;
      $_SESSION['email-professor'] = $data->email;
      $_SESSION['done'] = 1;
      header('Location: ../../../views/putProfessorInformation.php?key='.$_GET["key"].'&id_principal='.$_GET["id_principal"]);
