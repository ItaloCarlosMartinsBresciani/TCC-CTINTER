<?php 
    ...
    $query = "SELECT p.id_person, p.name_person, p.telephone_person, p.email_person, p.register_date FROM person p, internship_data i WHERE p.valid AND p.id_person = i.fk_student AND fk_supervisor = ".$_SESSION["idUser"]."";
    ...
    if($count > 0) {
        ...
        foreach($filterPerson as $key => $person) {  
            ...
            {
                $edition = '<a href="../../app/php/supervisor/logic/allowRequestLogic.php?type=block&id='.$idHex.'" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Bloquear edição.">
                                <i class="fas fa-times-circle"></i>
                            </a>';        
            }
            else //se ele está bloqueado
            {
                $edition = '<a href="../../app/php/supervisor/logic/allowRequestLogic.php?type=allow&id='.$idHex.'" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Permitir edição.">
            ...
            <tr>
                ...
                <td>
                    <a href="SupervisorInfo.php?type=intern&id='.$idHex.'" class="btn btn-primary">
