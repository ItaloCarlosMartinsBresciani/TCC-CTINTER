<?php
    ...
    $query = "SELECT * FROM person p, internship_data i WHERE p.valid AND i.fk_student = ".$_SESSION["idUser"]." AND finished = false";
    ...
    if($return != null){
      header("Location: ../intern/internPage.php");
    } 
?>
...
<body>
    ...
    <li>
      <div><i class="fa fa-user-graduate"></i> Professores</div> 
    </li>
     <li>
      ...
      <a href="../../app/php/logout.php" id="logout" style="margin-top: 145%;">
