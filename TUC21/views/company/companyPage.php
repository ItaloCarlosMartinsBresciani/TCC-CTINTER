...
<body>
    ...
    <ul class="sidebar-nav">
      ...
      <li>
        <div><i class="fa fa-user-graduate"></i> Estagiários</div>
      </li>
      <li>
        <div><i class="fa fa-users"></i> Funcionários</div>
      </li>
      <li>
        <div><i class="fa fa-user"></i> Perfil</div>
      </li>

      <a href="../../app/php/logout.php" id="logout" style="margin-top: 165%;">
    ...
    <div class="modal fade show" id="excludeModal" role="dialog" tabindex="-1" aria-labelledby="excludeModalTitle" aria-hidden="true" onload="teste()">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <form action="../../app/php/company/logic/companyExcludeLogic.php" method="GET">
            <div class="modal-body"></div>
            <div class="modal-footer">
              <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Fechar</button>
