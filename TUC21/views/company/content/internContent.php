<?php 
    ...
    $query = "SELECT p.id_person, p.name_person, p.telephone_person, p.email_person, p.register_date FROM person p, internship_data i WHERE p.valid AND p.id_person = i.fk_student AND fk_company = ".$_SESSION["idUser"]."";
