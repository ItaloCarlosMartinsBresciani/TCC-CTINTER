<?php 
    ...
    $query = 'SELECT p.id_person, p.name_person, p.telephone_person, p.email_person, p.treatment_person, p.register_date, i.valid FROM person p, internship_data i, student s WHERE p.valid AND p.id_person = i.fk_student AND s.fk_id = i.fk_student AND i.finished = FALSE AND s.fk_university = '.$id_university;
    ...
    if($count > 0) {
        ...
        <table class="table table-striped">
            <thead class="table-dark">
                <tr>
                    ...
                    <th scope="col">Validação do Estágio</th>
        ...
        foreach($filterPerson as $key => $person) {
            ...
            <tr>
                ...
                <td>
                    <a href="coordinatorInfo.php?type=intern&id='.$idHex.'" class="btn btn-primary">
