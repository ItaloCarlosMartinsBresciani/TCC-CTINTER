<?php 
    ...
    $query = 'SELECT p.id_person, p.name_person, p.telephone_person, p.email_person, p.treatment_person, p.register_date, p.valid FROM person p, advisor a WHERE p.valid AND p.id_person = a.fk_id AND a.fk_university = '.$id_university;
