...
<head>
    ...
    <title>Informação - Coordenador</title>
            ...
            <div class="row">
                <div class="col-lg-12 py-2" id="content">                        
                        <?php
                            if ($type == 'person') {
                              ...
                              if($return['valid']) {
                                ...
                                echo '<h2 class="py-2">Informações - '.$return['name_person'].' 
                                        <a href="coordinatorEditStudent.php?type=person&id='.$idHex.'"> <!--botão de edição -->
                                ...
                                if($return['valid']) {
                                    ...
                                    "
                                        ...
                                        <div class='col-lg-6 col-sm-12'>
                                            ...
                                            <label for='telephone2_company' class='lead fw-normal'>Contato da empresa:</label>
                                            <input type='text' id='telephone2_company' class='form-control' name='telephone2_company' value='".$return['telephone2_company']."' disabled><br>
                                ...
                                $query = 'SELECT * FROM internship_data WHERE fk_student = :id AND finished = false';
                                ...
                                if($return)
                                {
                                    if($return['nature_internship_data'] == true)
                                    {
                                        ...
                                        echo '<h3 class="py-2">Informações - Estágio obrigatório de '.$name_person.' 
                                                <a href="coordinatorEdit.php?type=internship&id='.codeId($return["id_internship_data"]).'"> <!--botão de edição -->
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-pencil-fill" viewBox="0 0 16 16">
                                                        <path d="M12.854.146a.5.5 0 0 0-.707 0L10.5 1.793 14.207 5.5l1.647-1.646a.5.5 0 0 0 0-.708l-3-3zm.646 6.061L9.793 2.5 3.293 9H3.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.207l6.5-6.5zm-7.468 7.468A.5.5 0 0 1 6 13.5V13h-.5a.5.5 0 0 1-.5-.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.5-.5V10h-.5a.499.499 0 0 1-.175-.032l-.179.178a.5.5 0 0 0-.11.168l-2 5a.5.5 0 0 0 .65.65l5-2a.5.5 0 0 0 .168-.11l.178-.178z"/>
                                                    </svg>
                                                </a>
                                    ...
                                    $stmt->bindValue(':id', $return["id_internship_data"]);
                                    ...
                                    if($report)
                                    {
                                        $finish = "<button type='button' class='btn btn-success col-lg-3 col-12 fw-bold' data-bs-toggle='modal' style='background-color: red;' data-bs-target='#finishInternshipModal'>FINALIZAR ESTÁGIO</button>";

                                        echo '<div class="modal fade show" id="finishInternshipModal" role="dialog" tabindex="-1" aria-labelledby="finishInternshipModalTitle" aria-hidden="true" onload="teste()">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                    <h5 class="modal-title" id="finishInternshipModalTitle">Finalização do Estágio</h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                    </div>
                                                    <form action="../../app/php/coordinator/logic/finishInternship.php" method="GET">
                                                    <div class="modal-body">Deseja finalizar o estágio?</div>
                                                    <div class="modal-footer">
                                                        <input type="hidden" name="id" value="'.codeId($report["fk_internship_data"]).'">
                                ...
                                foreach($return as $report) {
                                    if($report['coordinator_signature_internship_report'] == NULL && $report['advisor_signature_internship_report'] != NULL && $report['supervisor_signature_internship_report'] != NULL)
                                ...
                                if($count > 0) {
                                    ...
                                    foreach($filterReport as $key => $report) {  
                                        ...
                                        if($report['supervisor_signature_internship_report'] != null && $report['coordinator_signature_internship_report'] == NULL && $report['advisor_signature_internship_report'] != NULL && $report['denied_internship_report'] != TRUE)
                                        {
                                            echo '
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="../../app/php/coordinator/logic/allowReportLogic.php?type=allow&id='.$idHex.'" class="btn btn-primary">
                                                            Sim
                                                        </a>
                                                        <a href="../../app/php/coordinator/logic/allowReportLogic.php?type=deny&id='.$idHex.'" class="btn btn-primary">
                                                            Não
                                                        </a>
                                                    </td>
                                                </tr>
                                ...
                                echo "
                                <h2>Estágio</h2>
                                <form action='../../app/php/email/sendEmailCoordinator.php' method='GET' name='form' id='form'>   
                            ...
                            else if($type == 'internship_finished')
                            {

                                $query = 'SELECT i.*, p.name_person FROM internship_data i, person p WHERE i.id_internship_data = :id AND i.fk_student = p.id_person';
                                ...
                                if($return)
                                {
                                    if($return['nature_internship_data'] == true)
                                    {
                                        ...
                                        echo '<h3 class="py-2">Informações - Estágio obrigatório (finalizado) de '.$name_person.'</h3>';
                                    }
                                    else
                                    {
                                        
                                        echo '<h3 class="py-2">Informações - Estágio não obrigatório (finalizado) de '.$name_person.'</h3>';
                            ...
                            if(isset($_SESSION['feedback'])) {
                                switch($_SESSION['feedback']) {
                                    case 'successClosure':
                                            echo "
                                            <script>
                                                openFeedbackModal('feedbackModal', 'Sucesso', 'Sucesso ao finalizar estágio.', ".$_SESSION['btn'].");
                                            </script>
                                            ";
                                            break;
                                    case 'errorClosure':
                                            echo "
                                            <script>
                                            openFeedbackModal('feedbackModal', 'Error', 'Erro ao finalizar estágio.', ".$_SESSION['btn'].");
                                            </script>
                                            ";
                                            break;
                                }
