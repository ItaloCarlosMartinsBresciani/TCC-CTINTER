...
<p>
    Página de visualização de orientadores existentes
</p>
...
<nav class="navbar navbar-light bg-light">
  <div class="container-fluid">
    ...
    <div class="d-flex">
        <a href="coordinatorRecycle.php?type=person" class="btn btn-success mx-3">
...
<div id="person-content">
    <?php
        require_once('../content/advisorContent.php');
    ?>
</div>