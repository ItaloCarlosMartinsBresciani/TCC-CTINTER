...
<?php
    ...
    if ($return)
    {
        echo "<a href='../../app/php/coordinator/logic/changeCoordinatorInformation.php'><button type='button' class='btn btn-primary'>Entrar como Professor</button></a>";
    }
    ...
    if($return['valid']) {
        ...
        echo '<h2 class="py-2">Informações - '.$return['name_person'].' 
                <a href="coordinatorEdit.php?type=profile&id='.$idHex.'"> <!--botão de edição -->
    ...
    if($return == null)
    {
        ...
        //-------------------------------------------------------------------------------------------
        //Selecionando o nome do coordenador e o id da universidade
        ...
        $name_coordinator = $return[0]['name_person'];
        ...
        echo "<div class='modal fade' id='sendEmailModal' tabindex='-1' aria-labelledby='sendEmailModalLabel' aria-hidden='true'>
            <div class='modal-dialog'>
                <div class='modal-content'>
                    ...
                    <form action='../../app/php/email/sendEmailCoordinator.php?type=editionRequest' method='POST'> 
                        <div class='modal-body'>
                            ...
                            <div class='mb-3'>
                                ...
                                <textarea class='form-control' id='message-text' name='message-text' style='height:200px;'>O(A) coordenador(a) ".$name_coordinator." está pedindo permissão para modificar seus dados pessoais. \n Acesse sua conta no Sistema de Controle de Estágio, entre na página HOME e clique no botão de PERMITIR EDIÇÃO para responder ao pedido.</textarea>
                            </div>
                        </div>
