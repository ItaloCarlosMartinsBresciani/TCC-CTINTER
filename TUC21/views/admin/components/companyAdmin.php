...
<p>
    Página de cadastro e informações de empresas
</p>

<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#sendEmailModal">Convidar Empresa</button>

<div class="modal fade" id="sendEmailModal" tabindex="-1" aria-labelledby="sendEmailModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="sendEmailModalLabel">Convidar Empresa</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form action="../../app/php/email/sendEmail.php" method="POST">
                <?php
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="message-text" name="message-text">Utilizando o link a seguir você poderá cadastrar sua empresa no controle de estágio da CTI.</textarea>
                    </div>
                </div>
...
<nav class="navbar navbar-light bg-light">
  <div class="container-fluid">
    ...
    <div class="d-flex">
        <a href="adminRecycle.php?type=company" class="btn btn-success mx-3">
