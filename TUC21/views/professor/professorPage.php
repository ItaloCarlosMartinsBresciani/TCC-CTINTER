...
<body>
    ...
    <ul class="sidebar-nav">
      ...
      <li>
        <div><i class="fa fa-user-friends"></i> Funcionários</div> 
      </li>
      <li>
        <div><i class="fa fa-user-graduate"></i> Alunos</div> <!-- Ele só vai ver os estudantes procurando orientadores -->
      </li>
      <li>
        <div><i class="fa fa-user-tie"></i> Meus Orientandos</div> <!-- Ele só vai ver os estudantes procurando orientadores -->
      </li>
      <li>
      ...
      <a href="../../app/php/logout.php" id="logout" style="margin-top: 130%;">
      ...
      if(isset($_SESSION['feedback'])) {
        switch($_SESSION['feedback']) {
          ...
          case 'successRecycle':
            echo "
            <script>
              openFeedbackModal('feedbackModal', 'Sucesso', 'Reativação bem sucedida.', ".$_SESSION['btn'].");
            </script>
            ";
            break;
          case 'errorRecycle':
            echo "
            <script>
              openFeedbackModal('feedbackModal', 'Erro', 'Ocorreu um erro durante a reativação.', ".$_SESSION['btn'].");
            </script>
            ";
          case 'successEdit':
            echo "
          ...
          case 'errorData':
            echo "
            <script>
              openFeedbackModal('feedbackModal', 'Erro', 'Os dados inseridos não estão no formato correto. Por favor, verifique novamente as orientações prescritas.', ".$_SESSION['btn'].");
            </script>
            ";
            break;
