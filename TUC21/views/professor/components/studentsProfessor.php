...
<p>
    Página de visualização de alunos da instituição
</p>

<!--<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#sendEmailModal">Convidar Alunos</button>

<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#registerStudentsModal">Cadastrar Vários Alunos</button>-->
...
<div class="modal fade" id="sendEmailModal" tabindex="-1" aria-labelledby="sendEmailModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="../../app/php/email/sendEmailProfessor.php?type=invitation" method="POST">
