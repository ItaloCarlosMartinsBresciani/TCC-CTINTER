...
<?php
    ...
    $id_professor = $_SESSION['idUser']; //id professor

    $query = "SELECT * FROM university_employee WHERE fk_id = $id_professor";
    ...
    if($return['valid']) {
        ...
        "
            ...
            <div class='col-lg-6 col-sm-12'>
                ...
                <a href='".$return['home_page_university']."'><input type='text' id='home_page_university' class='form-control' name='home_page_university' value='".$return['home_page_university']."' disabled></a><br>
            </div>
            <div class='col-lg-6 col-sm-12'>
                ...
                <a href='mailto:".$return['email_university']."?subject=Hello%20again'>
                    <input type='text' id='email_university' class='form-control' name='email_university' value='".$return['email_university']."' disabled>    
                </a><br> 
            </div>
            </div>
        ";   
