<?php 
    ...
    $query = 'SELECT person.id_person, person.name_person, person.telephone_person, person.email_person, person.treatment_person, person.register_date, person.valid, person.access_level FROM person, university_employee WHERE person.valid AND person.id_person = university_employee.fk_id AND university_employee.fk_university = '.$id_university.';';
