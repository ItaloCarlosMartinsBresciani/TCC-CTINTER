...
$pdf->MultiCell(450,20, utf8_decode("          Realizei estágio na empresa ".$return_company["name_company"].", no período de ".date_format($start_date, "d/m/Y")." à ".date_format($end_date, "d/m/Y").", sob a orientação do professor ".$return_advisor["name_person"].", e venho através desta solicitar a convalidação desse estágio, pelo motivo de ".$change_reason."."), 0, "J", false);
