...
<?php
    ...
    if($return['valid']) {
        ...
        echo '<h2 class="py-2">Informações - '.$return['name_person'].' 
                <a href="internEdit.php?type=person&id='.$idHex.'" > <!--botão de edição -->
        ...
        <div class='row'>
                <div class='col-lg-6 col-sm-12'>
                    ...
                    <input type='tel' id='cep-student' class='form-control' name='cep-student' value='".$return2['cep_student']."' disabled><br>
                    <label for='city-student' class='lead fw-normal'>Cidade:</label>
                    <input type='tel' id='city-student' class='form-control' name='city-student' value='".$return2['city_student']."' disabled><br>
                </div>
                <div class='col-lg-6 col-sm-12'>
    ...
    if($return == null)
    {
        ...
        $query = "SELECT p.name_person, i.fk_advisor FROM person p, internship_data i WHERE p.id_person = ".$id_person." AND i.fk_student = p.id_person ";
        ...
        $query = "SELECT email_person FROM person WHERE id_person = ".$id_advisor."";
        ...
        $email_advisor = $return['email_person'];
        ...
        echo "<div class='modal fade' id='sendEmailModal' tabindex='-1' aria-labelledby='sendEmailModalLabel' aria-hidden='true'>
            <div class='modal-dialog'>
                <div class='modal-content'>
                    ...
                    <form action='../../app/php/email/sendEmailIntern.php?type=profile' method='POST'> 
                        <div class='modal-body'>
                            <div class='mb-3'>
                                <label for='message-email' class='col-form-label'>E-mail:</label>
                                <input type='email' class='form-control' id='message-email' name='message-email' value=".$email_advisor.">
                            </div>
                            <div class='mb-3'>
                            ...
                            <div class='mb-3'>
                                ...
                                <textarea class='form-control' id='message-text' name='message-text' style='height:200px;'>O(A) aluno(a) ".$name_intern." está pedindo permissão para modificar seus dados pessoais. \n Acesse sua conta no Sistema de Controle de Estágio, entre na página HOME e clique no botão de PERMITIR EDIÇÃO para responder ao pedido.</textarea>
                            </div>
                        </div>
